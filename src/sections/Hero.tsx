...
export const Hero = () => {
  ...
  return (
    <motion.section
      ...
      animate={{ backgroundPositionX: star.width }}
    ...
    >
      ...
      <div className="container relative mt-16">
        <h1 className="text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-clip-text text-center text-transparent bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))]">
          AI SEO
        </h1>
        <p className="text-lg md:text-xl text-center text-white/70 mt-5 max-w-xl mx-auto">
          Revolutionize your content strategy with our AI-powered SEO tools.
        </p>
